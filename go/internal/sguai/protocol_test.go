...
func TestBuildSetMode(t *testing.T) {
	cases := []struct {
		...
		{"scrollRight", []byte{0xFF, 0x55, 0x07, 0x00, 0x02, 0x23, 0x01}},
		{"scrollLeft", []byte{0xFF, 0x55, 0x07, 0x00, 0x02, 0x23, 0x02}},
		{"flashing", []byte{0xFF, 0x55, 0x07, 0x00, 0x02, 0x23, 0x03}},
		// Case insensitivity / normalization
		{"SCROLLRIGHT", []byte{0xFF, 0x55, 0x07, 0x00, 0x02, 0x23, 0x01}},
		{"scroll-right", []byte{0xFF, 0x55, 0x07, 0x00, 0x02, 0x23, 0x01}},
	}
	for _, tc := range cases {
